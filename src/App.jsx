 ...
 const arrayJobsPages = [
  ...
  return (
    <div className={app.wrapper}>
      <Header activ={activ}  open={open} />

      <Routes>
        <Route element={<Blog  open={open} arrayCardBlog={arrayCardBlog} />} path="Blog" />
        <Route element={<Job  open={open} arrayJobsPages={arrayJobsPages} />} path="Works" />
